        ...
        <div
            ...
            <form action="{{ route('criterias.store') }}" method="POST">
                ...
                <div class="relative flex-auto p-4">
                    <p>Nama Criteria</p>
                    <input dropzone type="text" name="name" id="name" required
                        class="mb-4 mt-2  text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-300 focus:outline-none">
                    <p>Tipe</p>
                ...
                <div
                    ...
                    <button type="submit" data-toggle="modal" data-target="#import"
                        class="inline-block px-8 py-2 m-1 mb-4 text-xs font-bold text-center text-white uppercase align-middle transition-all border-0 rounded-lg cursor-pointer ease-soft-in leading-pro tracking-tight-soft bg-gradient-to-tl from-blue-700 to-blue-200 shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85">Tambahkan</button>
                </div>
            </form>
        </div>
    </div>
