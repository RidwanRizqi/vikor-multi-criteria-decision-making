<aside
    ...
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="https://github.com/Syaroful/decisio-net" target="_blank">
            <img src="{{ asset('assets/img/illustrations/trufalse.jpg') }}"
                class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">VIKOR DSS</span>
        </a>
    </div>
        ...
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap {{ request()->is('/') ? 'shadow-soft-xl rounded-lg bg-white px-4 font-semibold text-slate-700' : 'px-4' }} transition-colors"
                    ...
                    <div
                        class="{{ request()->is('/') ? 'bg-gradient-to-tl from-blue-700 to-blue-200' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap {{ request()->is('criterias') ? 'shadow-soft-xl rounded-lg bg-white px-4 font-semibold text-slate-700' : 'px-4' }} transition-colors"
                    ...
                    <div
                        class="{{ request()->is('criterias') ? 'bg-gradient-to-tl from-blue-700 to-blue-200' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="12px" height="12px" x="0" y="0"
                            viewBox="0 0 512 512" style="enable-background: new 0 0 512 512" xml:space="preserve">
                            <g>
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap {{ request()->is('alternatives') ? 'shadow-soft-xl rounded-lg bg-white px-4 font-semibold text-slate-700' : 'px-4' }} transition-colors"
                    ...
                    <div
                        class="{{ request()->is('alternatives') ? 'bg-gradient-to-tl from-blue-700 to-blue-200' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center fill-current stroke-0 text-center xl:p-2.5">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                        xmlns:xlink="http://www.w3.org/1999/xlink" width="12px" height="12px" x="0" y="0"
                        viewBox="0 0 512 512" style="enable-background: new 0 0 512 512" xml:space="preserve">
                        <g>
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap {{ request()->is('values') ? 'shadow-soft-xl rounded-lg bg-white px-4 font-semibold text-slate-700' : 'px-4' }} transition-colors"
                    ...
                    <div
                        class="{{ request()->is('values') ? 'bg-gradient-to-tl from-blue-700 to-blue-200' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap {{ request()->is('vikor') ? 'shadow-soft-xl rounded-lg bg-white px-4 font-semibold text-slate-700' : 'px-4' }} transition-colors"
                    href="{{ route('vikor.index') }}">
                    <div
                        class="{{ request()->is('vikor') ? 'bg-gradient-to-tl from-blue-700 to-blue-200' : ''}} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                ...
                                <g transform="translate(-2020.000000, -442.000000)" fill="#FFFFFF"
                                    ...
                                    <g transform="translate(1716.000000, 291.000000)">
                                        <g transform="translate(304.000000, 151.000000)">
                                            <polygon class="{{ request()->is('vikor') ? '' : 'fill-slate-800 opacity-60'}}"
                                                points="18.0883333 15.7316667 11.1783333 8.82166667 13.3333333 6.66666667 6.66666667 0 0 6.66666667 6.66666667 13.3333333 8.82166667 11.1783333 15.315 17.6716667">
                                            </polygon>
                                            <path class="{{ request()->is('vikor') ? '' : 'fill-slate-800 opacity-60'}}"
                                                d="M31.5666667,23.2333333 C31.0516667,23.2933333 30.53,23.3333333 30,23.3333333 C29.4916667,23.3333333 28.9866667,23.3033333 28.48,23.245 L22.4116667,30.7433333 L29.9416667,38.2733333 C32.2433333,40.575 35.9733333,40.575 38.275,38.2733333 L38.275,38.2733333 C40.5766667,35.9716667 40.5766667,32.2416667 38.275,29.94 L31.5666667,23.2333333 Z">
                                            </path>
                                            <path class="{{ request()->is('vikor') ? '' : 'fill-slate-800'}}"
