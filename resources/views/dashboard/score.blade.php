                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <button type="button" data-modal-target="add-value-{{ $alternative->id }}"
                                                    ...
                                                    class="inline-block px-6 py-3 mr-3 my-3 font-bold text-center uppercase align-middle transition-all bg-transparent border rounded-lg cursor-pointer border-blue-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-102 active:opacity-85 hover:shadow-soft-xs text-blue-500">
                                                    Edit</button>
                                            </td>
